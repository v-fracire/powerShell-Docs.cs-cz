...
ms.locfileid: "37892796"
---
# <a name="installation-of-module-dependencies"></a><span data-ttu-id="d707e-102">Instalace závislostí modulů</span><span class="sxs-lookup"><span data-stu-id="d707e-102">Installation of Module Dependencies</span></span>

<span data-ttu-id="d707e-103">Podpora verzí modulu vedle sebe (SxS) v Install-Module, už aktualizace modulu a rutiny Publish-Module, který běží ve Windows Powershellu 5.0 nebo novější.</span><span class="sxs-lookup"><span data-stu-id="d707e-103">There is now side-by-side (SxS) module version support in Install-Module, Update-Module, and Publish-Module cmdlets that run in Windows PowerShell 5.0 or newer.</span></span>
<span data-ttu-id="d707e-104">Také jsme přidali parametru - RequiredVersion do rutiny Publish-Module k určení verze pro publikování.</span><span class="sxs-lookup"><span data-stu-id="d707e-104">Also, we have added a -RequiredVersion parameter to the Publish-Module cmdlet to specify the version to be published.</span></span> <span data-ttu-id="d707e-105">Parametr cesty teď podporuje základní cesta modulu se složkou verze.</span><span class="sxs-lookup"><span data-stu-id="d707e-105">The Path parameter now supports the module base path with the version folder.</span></span>

<span data-ttu-id="d707e-106">**Příklady Install-Module:**</span><span class="sxs-lookup"><span data-stu-id="d707e-106">**Install-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="d707e-107">**Nainstalujte modul závislosti:**</span><span class="sxs-lookup"><span data-stu-id="d707e-107">**Install a module with dependencies:**</span></span>
```powershell
PS C:\windows\system32> Get-InstalledModule
...
<span data-ttu-id="d707e-108">**Obsah modulu ModuleWithDependencies2 soubor manifestu:**</span><span class="sxs-lookup"><span data-stu-id="d707e-108">**Contents of ModuleWithDependencies2 module manifest file:**</span></span>
```powershell
@{
...
<span data-ttu-id="d707e-109">**Aktualizace modulu příklady:**</span><span class="sxs-lookup"><span data-stu-id="d707e-109">**Update-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="d707e-110">**Příklady Publish-Module:**</span><span class="sxs-lookup"><span data-stu-id="d707e-110">**Publish-Module examples:**</span></span>
```powershell
