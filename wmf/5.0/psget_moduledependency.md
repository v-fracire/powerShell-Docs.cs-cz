...
---
# <a name="installation-of-module-dependencies"></a>Instalace závislostí modulů

Podpora verzí modulu vedle sebe (SxS) v Install-Module, už aktualizace modulu a rutiny Publish-Module, který běží ve Windows Powershellu 5.0 nebo novější.
Také jsme přidali parametru - RequiredVersion do rutiny Publish-Module k určení verze pro publikování. Parametr cesty teď podporuje základní cesta modulu se složkou verze.

**Příklady Install-Module:**
```powershell
...
**Obsah modulu ModuleWithDependencies2 soubor manifestu:**
```powershell
@{
