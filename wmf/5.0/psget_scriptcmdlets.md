...
## <a name="save-script-cmdlet"></a>Uložení skriptu rutiny
...
## <a name="update-script-cmdlet"></a>Skript aktualizace rutiny
...
## <a name="uninstall-script-cmdlet"></a>Rutiny odinstalovat skriptu
```powershell
...
## <a name="new-scriptfileinfo-and-test-scriptfileinfo-cmdlets"></a>Rutiny nové ScriptFileInfo a ScriptFileInfo testu
Nové ScriptFileInfo rutina umožňuje vytvořit nový soubor skriptu s metadaty, jako je verze, Guid, autora a popis, atd. Rutina test-ScriptFileInfo umožňuje ověřit a získat metadata souboru skriptu.
```powershell
...
Pomocí rutiny Register-PSRepository/Set-PSRepository přidejte **ScriptSourceLocation** a **ScriptPublishLocation** k PSRepository.
```powershell
...
## <a name="publish-script-cmdlet"></a>Publikování skript rutiny
Publikování skriptu rutina umožňuje publikování souboru skriptu s platnou metadaty, jako je verze, Guid, autora a popis, atd.
```powershell
