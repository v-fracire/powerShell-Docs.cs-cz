...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="7bdce-102">Zjišťování skriptů prostředí PowerShell, instalace a správy s PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="7bdce-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="7bdce-103">Skript prostředí PowerShell sdílení funkce tu přidat do PowerShellGet ve verzi WMF 5.0 RTM.</span><span class="sxs-lookup"><span data-stu-id="7bdce-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="7bdce-104">Následující nové rutiny jsou přidány do modulu PowerShellGet pro podporu skriptů prostředí PowerShell.</span><span class="sxs-lookup"><span data-stu-id="7bdce-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="7bdce-105">Syntaxe skriptu sdílení rutiny:</span><span class="sxs-lookup"><span data-stu-id="7bdce-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
