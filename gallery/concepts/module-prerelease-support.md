...
<span data-ttu-id="eef42-125">Podrobné požadavky pro předběžné verze řetězce jsou:</span><span class="sxs-lookup"><span data-stu-id="eef42-125">The detailed requirements for Prerelease string are:</span></span>
