...
#### <a name="storing-objects-in-variables"></a><span data-ttu-id="d2d74-123">Ukládání objektů v proměnné</span><span class="sxs-lookup"><span data-stu-id="d2d74-123">Storing Objects in Variables</span></span>
