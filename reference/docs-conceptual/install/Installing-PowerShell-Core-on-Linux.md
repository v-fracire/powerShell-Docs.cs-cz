...
Podporuje [Ubuntu 14.04][u14], [Ubuntu 16.04][u16], [Ubuntu 18.04] [ u1804], [Ubuntu 18.10][u1810], [Debian 8][deb8], [Debian 9] [ deb9], [CentOS 7][cos], [Red Hat Enterprise Linux (RHEL) 7][rhel7], [openSUSE 42.3][opensuse], [openSUSE skok 15][opensuse], [Fedora 27][fedora], [ Fedora 28][fedora], a [Arch Linux][arch].
...
### <a name="installation---opensuse-423"></a>Instalace - openSUSE 42.3
...
### <a name="installation---opensuse-leap-15"></a>Instalace - openSUSE skok 15
...
### <a name="uninstallation---opensuse-423-opensuse-leap-15"></a>Odinstalace - openSUSE 42.3, openSUSE skok 15
...
Pokud chcete nainstalovat verzi preview, použít následující metody.
...
Po instalaci modulu Snap budou automaticky upgradovat, ale můžete aktivovat upgradu pomocí `sudo snap refresh powershell` nebo `sudo snap refresh powershell-preview`.
...
### <a name="installation---kali"></a>Instalace - Kali
...
### <a name="installation---raspbian"></a>Instalace - Raspbian
...
| CentOS 7 <br> Oracle Linux 7 <br> RHEL 7 | libunwind libcurl, knihovny openssl, libicu |
| OpenSUSE 42.3 | libcurl4 libopenssl1_0_0, libicu52_1 |
| openSUSE skok 15 | libcurl4 libopenssl1_0_0, libicu60_2 |
