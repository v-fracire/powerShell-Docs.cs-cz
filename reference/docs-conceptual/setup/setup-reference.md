...
---
# <a name="setup-guide"></a>Průvodce nastavením

- [Instalace jádra prostředí PowerShell v systému macOS a Linux](Installing-PowerShell-Core-on-macOS-and-Linux.md)
- [Instalace jádra prostředí PowerShell v systému Windows](Installing-PowerShell-Core-on-Windows.md)
- [Instalace prostředí Windows PowerShell](Installing-Windows-PowerShell.md)
- [Instalace jádra Windows PowerShellu 2.0](Installing-the-Windows-PowerShell-2.0-Engine.md)
- [Instalace sady SDK Windows PowerShellu](Installing-the-Windows-PowerShell-SDK.md)
- [Odkaz na instalační program](setup-reference.md)
- [Usnadnění přístupu v systému Windows PowerShell ISE](Accessibility-in-Windows-PowerShell-ISE.md)
