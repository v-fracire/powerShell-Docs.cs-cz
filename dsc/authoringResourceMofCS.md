...
## <a name="writing-a-cmdlet-based-resource"></a>Zápis prostředek založenou na rutině
V tomto příkladu bude implementaci jednoduché prostředek, který spravuje textového souboru a jeho obsah.

### <a name="writing-the-mof-schema"></a>Zápis schéma MOF

Toto je MOF definici prostředků.
...
1. Vytvoření projektu C# a zadejte název.
1. Vyberte **knihovny tříd** ze šablon projektu k dispozici.
1. Klikněte na tlačítko **Ok**.
1. Přidáte odkaz na sestavení pro System.Automation.Management.dll do projektu.
1. Změňte název sestavení tak, aby odpovídaly názvu prostředku. V takovém případě by měla mít název sestavení **MSFT_XDemoFile**.

### <a name="writing-the-cmdlet-code"></a>Psaní kódu rutiny

Následující kód C# implementuje **Get-TargetResource**, **Set-TargetResource**, a **Test TargetResource** rutiny.
...
### <a name="deploying-the-resource"></a>Nasazení na prostředek

Kompilovanou knihovnu dll soubor by měl být uložen v podobná prostředek založených na skriptech struktury souborů. Zde je strukturu složek pro tento prostředek.
