...
>**Poznámka:** Obecné kolekce nejsou podporovány v založené na třídě prostředků.
...
- **DscProperty(Key)**: Tato vlastnost je vyžadovaná. Vlastnost je klíč. Hodnoty všech vlastností označený jako obsahující kombinaci kláves k jednoznačné identifikaci instance prostředku v rámci konfigurace.
- **DscProperty(Mandatory)**: Tato vlastnost je vyžadovaná.
...
**$Path** a **$SourcePath** vlastnosti jsou obou řetězců. **$CreationTime** je [data a času](/dotnet/api/system.datetime) vlastnost. **$Ensure** vlastnost je typ výčtu, definovaná následujícím způsobem.
