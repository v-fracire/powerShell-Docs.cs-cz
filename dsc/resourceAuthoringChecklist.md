...
Ověření schématu prostředků (*. schema.mof) soubor. Můžete použít [Návrhář prostředků DSC](https://www.powershellgallery.com/packages/xDSCResourceDesigner) usnadňují vývoj a testování vašeho schématu.
Ujistěte se, že:
...
Kromě toho byste měli použít **testovací xDscResource** a **testovací xDscSchema** rutiny z [Návrhář prostředků DSC](https://www.powershellgallery.com/packages/xDSCResourceDesigner) můžete si automaticky ověřit zdroj a schéma:
...
- : Největší problém s chybovými zprávami je, že často neexistují, proto se ujistěte, že jsou zde.
- Snadná na pochopení: lidské čitelný, ne skrytého chybové kódy
- Přesné: Popisují, co je právě tento problém
...
## <a name="best-practice-resource-supports--whatif"></a>Osvědčený postup: - WhatIf prostředek podporuje.
